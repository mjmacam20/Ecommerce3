...
<head>
    ...
    <title>Wavepad</title>
    <!-- Standard Favicon -->
    <link href="/front/images/favicon.png" rel="shortcut icon">
    ...
    <link rel="stylesheet" href="/front/css/jquery-ui-range-slider.min.css">
    <!-- Utility -->
    <link rel="stylesheet" href="/front/css/utility.css">
    <!-- Main -->
...
<div class="loader">
   <img src="/front/images/loaders/loader.gif" alt="loading..." />
</div>
...
<!-- Elevate Zoom -->
<script type="text/javascript" src="/front/js/jquery.elevatezoom.min.js"></script>
<!-- jquery-ui-range-slider -->
<script type="text/javascript" src="/front/js/jquery-ui.range-slider.min.js"></script>
<!-- jQuery Slim-Scroll -->
<script type="text/javascript" src="/front/js/jquery.slimscroll.min.js"></script>
<!-- jQuery Resize-Select -->
<script type="text/javascript" src="/front/js/jquery.resize-select.min.js"></script>
<!-- jQuery Custom Mega Menu -->
<script type="text/javascript" src="/front/js/jquery.custom-megamenu.min.js"></script>
<!-- jQuery Countdown -->
<script type="text/javascript" src="/front/js/jquery.custom-countdown.min.js"></script>
<!-- Owl Carousel -->
