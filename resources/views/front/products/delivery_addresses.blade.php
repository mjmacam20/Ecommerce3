@if(count($deliveryAddresses)>0)
    ...
    <div class="control-group" style="float:left; margin-right: 15px"><input type="radio" id="address{{ $address['id'] }}" name="address_id" value="{{ $address['id'] }}"></div>

    <div><label clas="control-label">{{ $address['name'] }}, {{ $address['address'] }}, {{ $address['city'] }}, {{ $address['state'] }}, {{ $address['country'] }}... </label>
